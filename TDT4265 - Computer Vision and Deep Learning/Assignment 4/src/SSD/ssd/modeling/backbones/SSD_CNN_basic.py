...
class BasicModel(torch.nn.Module):
    ...
    def __init__(self,
        ...
        self.layer_2 = _X2ReLUConv2d(in_channels=self.out_channels[0], middle_channels=128, out_channels=self.out_channels[1])
        ...
        self.layer_6 = _X2ReLUConv2d(in_channels=self.out_channels[4], middle_channels=128, out_channels=self.out_channels[5], padding_two=0, stride_two=1)
