...
class _X2_BatchNorm_ReLU_Conv2d(nn.Sequential):
...
class ExperimentModel(torch.nn.Module):
    def __init__(self,
        ...
        self.layer_2 = _X2_BatchNorm_ReLU_Conv2d(in_channels=self.out_channels[0], middle_channels=256, out_channels=self.out_channels[1])
        self.layer_3 = _X2_BatchNorm_ReLU_Conv2d(in_channels=self.out_channels[1], middle_channels=256, out_channels=self.out_channels[2])
        self.layer_4 = _X2_BatchNorm_ReLU_Conv2d(in_channels=self.out_channels[2], middle_channels=128, out_channels=self.out_channels[3])
        self.layer_5 = _X2_BatchNorm_ReLU_Conv2d(in_channels=self.out_channels[3], middle_channels=128, out_channels=self.out_channels[4])
        self.layer_6 = _X2_BatchNorm_ReLU_Conv2d(in_channels=self.out_channels[4], middle_channels=256, out_channels=self.out_channels[5], padding_two=0)
